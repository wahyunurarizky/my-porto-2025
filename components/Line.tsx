...
export function HorizontalLine(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 266 8' preserveAspectRatio='none' shapeRendering='crispEdges' {...props}>
      <path
        fill='none'
        stroke='currentColor'
...
export function VerticalLine(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 555' preserveAspectRatio='none' shapeRendering='crispEdges' {...props}>
      <path
        fill='none'
        stroke='currentColor'
